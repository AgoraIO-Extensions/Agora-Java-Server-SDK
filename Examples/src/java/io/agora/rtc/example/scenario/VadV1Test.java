...
public class VadV1Test {
    private static String audioFile = "test_data/vad_test.pcm";
    private static String audioExpectedFile = "test_data/vad_test_expected.pcm";
    private static String audioOutFile = "test_data_out/vad1_test_out.pcm";
    private static final int SAMPLE_RATE = 16000;
    private static final int NUM_CHANNELS = 1;
    private static final int BIT_DEPTH = 16;
    private static final int MILLISECONDS = 10;
    private static PcmReader pcmReader;
    private static FileWriter fileWriter;
    private static AgoraAudioVad audioVad;

    private static final ExecutorService taskExecutor = Executors.newSingleThreadExecutor();

    private static CountDownLatch taskFinishLatch = new CountDownLatch(1);

    // audio thread
    // send audio data every 10 ms;
    static class PcmReader extends FileSender {
