...
public class StressReceiverYuvTest extends AgoraTest {
    private long testStartTime;
    private final ThreadPoolExecutor testTaskExecutorService;

    public StressReceiverYuvTest() {
    ...
    public static void main(String[] args) {
        startTest(args, new StressReceiverYuvTest());
    }
        ...
        for (int i = 0; i < connectionCount; i++) {
            ...
            testTaskExecutorService.execute(() -> {
                ...
                while (checkTestTime()) {
                    ...
                    createConnectionAndTest(ccfg, channelId + threadId, userId + threadId + (index++),
